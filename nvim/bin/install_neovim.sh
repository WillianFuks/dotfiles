...
# Inspired by:
# https://github.com/LunarVim/LunarVim/blob/master/utils/installer/install-neovim-from-release

set -euo pipefail

declare -r INSTALL_PREFIX="${INSTALL_PREFIX:-"$HOME/.local"}"
declare -r RELEASE_VER="${RELEASE_VER:-latest}"
declare -r ARCHIVE_NAME="nvim-linux64"
...
function download_neovim() {
  ...
  echo "Destination file: $DOWNLOAD_DIR/$ARCHIVE_NAME.tar.gz"
